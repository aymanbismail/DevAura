...
<img src="public/logo/devaura-logo.png" alt="DevAura Logo" width="120" />
...
**[Live Demo](https://devaura.vercel.app)** · **[Report a Bug](https://github.com/aymanbismail/DevAura/issues)** · **[Request a Feature](https://github.com/aymanbismail/DevAura/issues)**
...
- [ ] **Backend open-source release** — Publish the Laravel API repository with a Docker Compose setup for local full-stack development
- [ ] **Roadmap / progress tracking** — Allow users to mark individual topics within a track as complete, with visual progress indicators
- [ ] **User-submitted resources** — Community contribution flow with admin moderation queue
- [ ] **Quiz leaderboard** — Opt-in score submission with a public leaderboard per topic
- [ ] **Multilingual support (i18n)** — Arabic first, given the primary target audience
- [ ] **Offline support (PWA)** — Service worker caching for quiz content to support low-bandwidth environments
- [ ] **Global search** — Search bar spanning tracks, resources, and AI tools simultaneously
- [ ] **E2E testing** — Playwright test suite for critical user flows (quiz completion, navigation, auth)
- [ ] **Storybook** — Component library documentation for the `ui/` components
